...
<?php else : ?>
<h2>Výsledky hledání/Search results</h2>
<p>Nebylo nic nalezeno. Zkuste to prosím znovu nebo použijte menu./No matches. Please try again, or use the navigation menus to find what you search for.</p>
<?php endif; ?>
